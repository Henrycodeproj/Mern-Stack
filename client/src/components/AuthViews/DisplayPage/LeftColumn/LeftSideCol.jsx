...
export const LeftColumn = () => {
  ...
  return (
    <div className="side_header">
      <div
        className="leftside_profile_card"
        style={{
          background: "rgba(139, 137, 137, 0.404)",
      ...
      <MenuList
        sx={{
          borderTop: "solid",
          borderTopColor: "rgb(255, 255, 255, .6)",
      ...
      >
        <MenuItem sx={{ margin: "10px 0px" }} className="leftsidebar_menuItems">
          ...
          <ListItemText sx={{ color: "white" }} className="list_item_text">
            Inbox
          </ListItemText>
        ...
        <Accordion
          sx={{ background: "none", boxShadow: "0 0 0 0", borderRadius: "5px" }}
          className="left_accordian"
        >
          <AccordionSummary
            className="accordian_summary"
            expandIcon={
              <ExpandMoreIcon className="expand_icon" sx={{ color: "white" }} />
            }
          ...
          >
            ...
            <Typography sx={{ color: "white" }} className="list_item_text">
              Settings
            </Typography>
          </AccordionSummary>
          <AccordionDetails>
        ...
        <MenuItem
          ...
          sx={{ margin: "10px 0px" }}
          className="leftsidebar_menuItems"
        >
          <ListItemIcon sx={{ color: "white" }}>
