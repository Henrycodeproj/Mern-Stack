  ...
  return (
    <div className="hero_section_container">
      ...
      <p style={{ color: "white", fontSize: "1rem", lineHeight: "1.5rem" }}>
        Neworking in college made easy. A platform that addresses the different
        types of personalities in college students and seeks to help break the
        ice to foster real in-person interactions. Posting live on-campus
        activities to encourage others to join and mingle.
      </p>
      <div className="avatar_container_wrapper">
        <motion.div whileHover={{ scale: 1.3, y: -10 }}>
          ...
          >
            <Avatar
              src="https://images.pexels.com/photos/3781529/pexels-photo-3781529.jpeg?auto=compress&cs=tinysrgb&w=1600"
              sx={avatarStyling}
            />
          </Tooltip>
        </motion.div>
        ...
        <motion.div whileHover={{ scale: 1.3, y: -10 }}>
          ...
          >
            <Avatar
              src="https://images.pexels.com/photos/5537546/pexels-photo-5537546.jpeg?auto=compress&cs=tinysrgb&w=1600"
              sx={avatarStyling}
            />
          </Tooltip>
        </motion.div>
        <motion.div whileHover={{ scale: 1.3, y: -10 }}>
          ...
          >
            <Avatar
              src="https://images.pexels.com/photos/13798632/pexels-photo-13798632.jpeg?auto=compress&cs=tinysrgb&w=1600"
              sx={avatarStyling}
            />
          </Tooltip>
        </motion.div>
